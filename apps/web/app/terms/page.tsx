    ...
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", color: "#0a2540", background: "#fff" }}>
      ...
      <section style={{ padding: "2.5rem 1.5rem 4rem" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={pStyle}>
            Threely offers a free 7-day trial that provides full access to all features. No payment information is required to start the trial.
          </p>
          <p style={pStyle}>
            After the trial, continued access to AI-generated tasks and coaching features requires a paid subscription. Subscriptions are billed either monthly or annually, depending on the plan you choose. Prices are displayed on our pricing page and may be updated with reasonable notice.
          </p>
          <p style={pStyle}>
