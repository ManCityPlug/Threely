      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
          ...
          <div className="marketing-nav-links" style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <Link href="/how-it-works" style={{ padding: "0.35rem 0.75rem", fontSize: "0.85rem", fontWeight: 500, color: "#425466", borderRadius: 6 }}>How it works</Link>
            <Link href="/pricing" style={{ padding: "0.35rem 0.75rem", fontSize: "0.85rem", fontWeight: 500, color: "#425466", borderRadius: 6 }}>Pricing</Link>
            <Link href="/faq" style={{ padding: "0.35rem 0.75rem", fontSize: "0.85rem", fontWeight: 500, color: "#425466", borderRadius: 6 }}>FAQ</Link>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <Link href="/register" onClick={handleMobileCTA} className="marketing-nav-links" style={{
            padding: "0.4rem 1rem",
            fontSize: "0.875rem",
            fontWeight: 600,
            color: "#fff",
        ...
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 14, marginBottom: "2rem" }}>
            <div style={{
              ...
              boxShadow: "0 8px 24px rgba(99,91,255,0.35), inset 0 2px 3px rgba(255,255,255,0.25)",
              textShadow: "0 2px 4px rgba(0,0,0,0.15)",
            }}>3</div>
            <span style={{ fontSize: "1.75rem", fontWeight: 800, letterSpacing: "-0.03em", color: "#0a2540" }}>Threely</span>
          </div>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div className="footer-grid" style={{
            ...
            {/* Product */}
            <div>
              <h4 style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase", marginBottom: 12 }}>Product</h4>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <Link href="/how-it-works" style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>How it works</Link>
                <Link href="/pricing" style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>Pricing</Link>
                <Link href="/faq" style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>FAQ</Link>
              </div>
            </div>
            {/* Company */}
            <div>
              <h4 style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase", marginBottom: 12 }}>Company</h4>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <Link href="/about" style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>About</Link>
                <Link href="/terms" style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>Terms of Service</Link>
                <Link href="/privacy" style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>Privacy Policy</Link>
              </div>
            </div>
            {/* Get Started */}
            <div>
              <h4 style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase", marginBottom: 12 }}>Get Started</h4>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <Link href="/register" onClick={handleMobileCTA} style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>Create account</Link>
                <Link href="/login" style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.825rem" }}>Sign in</Link>
              </div>
            </div>
          </div>
